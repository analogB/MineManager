...
valueF_2mineadp<- function(nper,pMine0,N){
    ...
    # Minerals are distributed randomly in every mine. A mine is generated randomly from one of the mine 
    # type distributions. The subject may choose to 1) create a new mineshaft, randomly revealing a  
    ...
    # This funtion estimates the value function for the Two Mine Problem associated with decision procedure (3).
    # It applies a double-pass approximate dynamic programming technique that iterates the value function over a
    # sample of mineral paths based on the belief at the time of the decision, while updating the belief over
    # the sample paths.
    ...
    #### INITIATION ####
    # Trials & Timesteps
    N           <- 10000 #number of samples including 1 additional for initiation
    nper        <- 20  #number of timesteps including 1 additional for termination
    ...
    # 2007 Powell ADP p274: Single Pass
